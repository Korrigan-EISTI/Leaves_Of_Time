...
[CustomEditor(typeof(SceneImportManager))]
public class SceneImporter : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        SceneImportManager manager = (SceneImportManager)target;
        ...
        string buttonText = isExporting ? "Importing" : "Import XML";
